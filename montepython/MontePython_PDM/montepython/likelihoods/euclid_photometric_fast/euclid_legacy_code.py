...
def euclid_photometric_z (self, cosmo, data, pk):
    ...
    if self.probe_WL and not self.probe_GC:
        self.fiducial_file = os.path.join(self.data_directory, self.fiducial_file_WL)
    elif self.probe_GC and not self.probe_WL:
        self.fiducial_file = os.path.join(self.data_directory, self.fiducial_file_GC)
    else:
        self.fiducial_file = os.path.join(self.data_directory, self.fiducial_file_XC)
