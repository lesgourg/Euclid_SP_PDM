...
# EMULATOR
#======================
def CWDM_suppression_PCA(k,z,M_wdm,f_wdm,emulator_root=HERE+'/CWDM_emulator_files'):
    ...
    if   f_wdm>1.:  raise ValueError("f_wdm must be smaller than 1")
    elif f_wdm==0.: return np.zeros((len(z),len(k)))
